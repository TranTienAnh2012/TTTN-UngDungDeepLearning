...
TASKS = {
    'LEFT': {'text': 'Quay mặt sang TRÁI', 'check': lambda pitch, yaw: yaw < -13},
    'RIGHT': {'text': 'Quay mặt sang PHẢI', 'check': lambda pitch, yaw: yaw > 13},
    'UP': {'text': 'Ngẩng đầu lên TRÊN', 'check': lambda pitch, yaw: pitch < -9},
    'DOWN': {'text': 'Cúi đầu xuống DƯỚI', 'check': lambda pitch, yaw: pitch > 9}
}
